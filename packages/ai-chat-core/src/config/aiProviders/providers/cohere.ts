...
export const COHERE: AIProvider = {
  ...
  persona: {
    basePersonality:
      "Enterprise linguist. Strong focus on language understanding and practical applications. Professional yet approachable, emphasizes clarity and actionable insights.",
    traits: [
