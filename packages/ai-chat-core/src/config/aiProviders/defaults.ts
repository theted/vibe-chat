...
export const DEFAULT_MODELS: Record<string, AIModel> = {
  ...
  [ZAI.name]: ZAI.models.ZAI_GLM_5_1,
  [GEMINI.name]: GEMINI.models.GEMINI_3_1_PRO,
  [MISTRAL.name]: MISTRAL.models.MISTRAL_LARGE,
  [OPENAI.name]: OPENAI.models.GPT5_5,
  [ANTHROPIC.name]: ANTHROPIC.models.CLAUDE_OPUS_4_7,
  [DEEPSEEK.name]: DEEPSEEK.models.DEEPSEEK_V4_FLASH,
  [GROK.name]: GROK.models.GROK_4_20,
  [QWEN.name]: QWEN.models.QWEN3_6_MAX_PREVIEW,
  [KIMI.name]: KIMI.models.KIMI_K2_6,
