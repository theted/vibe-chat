...
describe("Icon Component", () => {
  describe("rendering", () => {
    ...
    it("should render null for invalid icon name without paths", () => {
      const { container } = render(
        <Icon name={"nonexistent-icon-xyz" as IconName} />,
      );
  ...
  describe("icon variants", () => {
    ...
    it("should fallback to modern when invalid variant specified", () => {
      render(
        <Icon
          name="chat"
          styleVariant={"nonexistent" as "modern" | "classic"}
        />,
      );
      const svg = document.querySelector("svg");
      expect(svg).toBeInTheDocument();
  ...
  describe("additional props", () => {
    it("should forward additional props to SVG element", () => {
      render(
        <Icon name="chat" data-testid="icon-test" aria-label="Chat icon" />,
      );
    ...
    it("should handle onClick event", () => {
      ...
      render(
        <Icon name="chat" onClick={handleClick} data-testid="clickable-icon" />,
      );
