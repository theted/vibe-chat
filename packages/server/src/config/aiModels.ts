...
export const PROVIDER_ENV_VARS: Record<string, string> = {
  ...
  INCEPTION: "OPENROUTER_API_KEY",
  SAKANA: "OPENROUTER_API_KEY",
  META_MUSE: "OPENROUTER_API_KEY",
  PRISMML: "OPENROUTER_API_KEY",
  UNBIASED: "OPENROUTER_API_KEY",
  NEXAGI: "OPENROUTER_API_KEY",
  INCLUSIONAI: "OPENROUTER_API_KEY",
