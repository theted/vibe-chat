...
export const STATS_TOTAL_USER_MESSAGES_KEY: string =
  "ai-chat:stats:messages:user";
export const STATS_LATEST_MESSAGES_KEY: string =
  "ai-chat:stats:messages:latest";
