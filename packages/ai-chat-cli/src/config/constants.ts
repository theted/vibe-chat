...
export const USAGE_LINES: readonly string[] = [
  ...
  '  npm start mistral:MISTRAL_SMALL grok:GROK_4_3 "What is love? Be sarcastic!"',
  '  npm start mistral:MISTRAL_SMALL grok:GROK_4_3 openai:GPT4O "What is love if sarcastic as possible"',
  '  npm start grok:GROK_4_3 gemini "What is the nature of consciousness?" 8',
] as const;
