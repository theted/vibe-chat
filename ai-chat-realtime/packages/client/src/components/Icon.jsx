...
const ICON_PATHS = {
  chat: {
    ...
    modern: {
      strokeWidth: 1.4,
      paths: [
        "M5 6.5h14v7H14.5L12 17l-2.5-3.5H5z",
        "M8.5 9.5h7",
        "M8.5 12h4"
      ]
    }
  ...
  send: {
    ...
    modern: {
      strokeWidth: 1.4,
      paths: [
        "M4.75 19.25L20 12 4.75 4.75 8 11.5l4 0.5-4 0.5z"
      ]
    }
  },
  sparkle: {
    ...
    modern: {
      strokeWidth: 1.4,
      paths: [
        "M12 4l1.5 3.5L17 9l-3.5 1.5L12 14l-1.5-3.5L7 9l3.5-1.5L12 4z"
      ]
    }
  },
  moon: {
  ...
  tag: {
    ...
    modern: {
      strokeWidth: 1.4,
      paths: [
        "M6 6.25h5.5L18.5 13.25 11.5 20.25H6V6.25z",
        "M8.75 9.5h.01"
      ]
    }
  }
